...
function checker(count) {
    ...
    calc(+count.value, +depositIndex);
}


function calc(invest, count) {
    return secondLevel(invest, count);
}

function secondLevel(invest, depIndex) {
    switch (depIndex) {
        case 1:
            calcProfit(invest, 1.0, 285);
            break;
        case 2:
            calcProfit(invest, 1.2, 285);
            break;
        case 3:
            calcProfit(invest, 1.4, 285);
            break;
        case 4:
            calcProfit(invest, 1.6, 285);
            break;
        case 5:
            calcProfit(invest, 1.8, 285);
            break;
        case 6:
            calcProfit(invest, 2.0, 285);
            break;
        default:
            break;
    }
